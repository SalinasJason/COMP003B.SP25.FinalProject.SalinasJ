...
namespace COMP003B.SP25.FinalProject.SalinasJ.Controllers
{
    public class OrganizersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrganizerId,Name,Email,PhoneNumber,Role")] Organizer organizer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrganizerId,Name,Email,PhoneNumber,Role")] Organizer organizer)
        {
